...
public class FrmAdministradorMod extends javax.swing.JFrame {
    ...
    public FrmAdministradorMod() {
        ...
        txtIdAdministrador.setText(ventana.dIdAdministrador);
        cboIdUsuario.setSelectedItem(ventana.dIdUsuario);                  
        txtCargo.setText(ventana.dCargo);
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(txtCargo.getText().equals("")){
            ...
            datos.setCargo(txtCargo.getText());
            
            datos.setIdAdministrador(Integer.parseInt(txtIdAdministrador.getText()));
