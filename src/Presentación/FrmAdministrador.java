...
public class FrmAdministrador extends javax.swing.JFrame {
    ...
    public void Mostrar(String busqueda){
        try{
            ...
            N_Administrador objAdministrador = new N_Administrador();
            modelo = objAdministrador.Lista(busqueda);
    ...
    public static String dIdAdministrador="",dIdUsuario="", dCargo="";
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(dIdAdministrador.equals("")){
            ...
            if(confirmacion == 0){
                ...
                datos.setIdAdministrador(Integer.parseInt(dIdAdministrador));
                func.eliminar(datos);
                Mostrar("");
                dIdAdministrador="";
            }           
    ...
    private void tablaAdministradorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaAdministradorMousePressed
        ...
        dIdAdministrador = tablaAdministrador.getValueAt(fila,0).toString();
        dIdUsuario = tablaAdministrador.getValueAt(fila,1).toString();
        dCargo = tablaAdministrador.getValueAt(fila,2).toString();
