...
public class FrmCategoria extends javax.swing.JFrame {
    ...
    public void Mostrar(String busqueda){
        try{
            ...
            modelo = objCategoria.Lista(busqueda);
    ...
    public static String dIdCategoria="",dNombre="", dDescripcion="";
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(dIdCategoria.equals("")){
            ...
            if(confirmacion == 0){
                ...
                datos.setIdCategoria(Integer.parseInt(dIdCategoria));
                func.eliminar(datos);
                Mostrar("");
                dIdCategoria="";
            }           
    ...
    private void tablaCategoriaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaCategoriaMousePressed
        ...
        dIdCategoria = tablaCategoria.getValueAt(fila,0).toString();
        dNombre = tablaCategoria.getValueAt(fila,1).toString();
        dDescripcion = tablaCategoria.getValueAt(fila,2).toString();
