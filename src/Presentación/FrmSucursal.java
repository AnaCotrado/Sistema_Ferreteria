...
public class FrmSucursal extends javax.swing.JFrame {
    ...
    public void Mostrar(String busqueda){
        try{
            ...
            modelo = objSucursal.Lista(busqueda);
    ...
    public static String dIdSucursal="",dIdAdministrador="", dNombre="", dDireccion="";
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(dIdSucursal.equals("")){
            ...
            if(confirmacion == 0){
                ...
                datos.setIdSucursal(Integer.parseInt(dIdAdministrador));
                func.eliminar(datos);
                Mostrar("");
                dIdAdministrador="";
            }           
    ...
    private void tablaSucursalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaSucursalMousePressed
        ...
        dIdSucursal = tablaSucursal.getValueAt(fila,0).toString();
        dIdAdministrador = tablaSucursal.getValueAt(fila,1).toString();
        dNombre = tablaSucursal.getValueAt(fila,2).toString();
        dDireccion = tablaSucursal.getValueAt(fila,3).toString();
