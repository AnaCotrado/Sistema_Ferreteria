...
public class FrmEmpleadoIns extends javax.swing.JFrame {
    ...
    public FrmEmpleadoIns() {
        ...
        ListaSucursal = func.IdSucursal();
        for(int i=0; i<ListaSucursal.size(); i++){
            cboIdSucursal.addItem(ListaSucursal.get(i));
        } 
    ...
    private void initComponents() {
        ...
        cboIdSucursal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccionar" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEmpleadoIns.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
